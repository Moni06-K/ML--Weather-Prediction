...
## Algorithm
1.Import required libraries and load the weather.csv dataset. 2.Select input features and handle missing values using mean().
...
## Output:
<img width="395" height="326" alt="image" src="https://github.com/user-attachments/assets/73f32f93-5fdc-4b9a-9256-7377ecb51077" />
